<?php
/*
Template Name: Home development
*/
get_header(); ?>
<!--homepage dev-->
...
<div class="homeslide" style="margin-bottom:1em;background-color:#000">
  	...
  	<h2 class="slider"><span class="morekeys"><a href="<?php echo site_url(); ?>/category/ceo-updates/">Archive</a></span> Chief Executive Updates</h2> 
