...
<div class="login" id="theme-my-login<?php $template->the_instance(); ?>">
    ...
    <p class="connect">Or social connect with:</p>
    
<?php do_action( 'wordpress_social_login' ); ?>
    
    
<div class="account-actions">
<p><a href="http://www.theshuttle.org.uk/register/">Register for an account</a> | <a href="http://www.theshuttle.org.uk/lostpassword/">I've lost my password!</a></p>
</div>
