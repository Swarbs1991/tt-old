...
class Related_Links_Widget_Box extends WP_Widget 
{
	...
	public function __construct() 
	{
		parent::__construct( false, __( 'Related Pages', 'related-links' ), array( 'description' => __( 'A list of related links', 'related-links' ) ) );
	}
	...
	public function form( $instance ) 
	{
		if ( isset( $instance[ 'title' ] ) ) 
		{
			...
			$title = __( 'Related Pages', 'related-links' );
		}
		?>
		<p>
